...
int run_convertRGBtoYUV(int c, char* src, char* dst){
    ...
    // Medicion de tiempo 
    FILE* fp = NULL;
    fp = fopen("../tests/data/data_rgb2yuv.csv", "a");
    clock_t t;
    t = clock();
...
int run_convertYUVtoRGB(int c, char* src, char* dst){
    ...
    // Medicion de tiempo 
    FILE* fp = NULL;
    fp = fopen("../tests/data/data_yuv2rgb.csv", "a");
    clock_t t;
    t = clock();
...
int run_fourCombine(int c, char* src, char* dst){
    ...
    // Medicion de tiempo 
    FILE* fp = NULL;
    fp = fopen("../tests/data/data_fourCombine.csv", "a");
    clock_t t;
    t = clock();
...
int run_linearZoom(int c, char* src, char* dst){
    ...
    // Medicion de tiempo 
    FILE* fp = NULL;
    fp = fopen("../tests/data/data_linearZoom.csv", "a");
    clock_t t;
    t = clock();
...
int run_maxCloser(int c, char* src, char* dst, float val){
    ...
    // Medicion de tiempo 
    FILE* fp = NULL;
    fp = fopen("../tests/data/data_maxCloser.csv", "a");
    clock_t t;
    t = clock();
