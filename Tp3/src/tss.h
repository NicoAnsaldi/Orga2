...
extern tss tss_zombisA[CANT_ZOMBIS];
extern tss tss_zombisB[CANT_ZOMBIS];


extern void tss_inicializar();
void reset_tss(unsigned short indice, unsigned int jugador, unsigned int x, unsigned int y);
